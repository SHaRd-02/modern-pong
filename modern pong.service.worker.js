...
/** @type {string} */
const CACHE_VERSION = '1745058599|102358693485';
/** @type {string} */
const CACHE_PREFIX = 'modern pong-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'modern pong.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["modern pong.html","modern pong.js","modern pong.offline.html","modern pong.icon.png","modern pong.apple-touch-icon.png","modern pong.worker.js","modern pong.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["modern pong.wasm","modern pong.pck","modern pong.side.wasm"];
